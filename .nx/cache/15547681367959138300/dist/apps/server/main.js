...
exports.AppController = AppController = tslib_1.__decorate([
    (0, common_1.Controller)('people') // Defines the route prefix for this controller (e.g., /api/people if using a global prefix)
    ,
...
async function bootstrap() {
    ...
    const GLOBAL_PREFIX = app.setGlobalPrefix('api'); // Set a global prefix for all routes
    await app.listen(3000);
    common_1.Logger.log(`🚀 Application is running on: http://localhost:3000/${GLOBAL_PREFIX}`);
}
bootstrap();
